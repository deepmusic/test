...
_NETPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='scale', full_name='caffe.NetParameter.scale', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max_size', full_name='caffe.NetParameter.max_size', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='multiple', full_name='caffe.NetParameter.multiple', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='mean_value', full_name='caffe.NetParameter.mean_value', index=12,
      number=203, type=2, cpp_type=6, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='class_enable', full_name='caffe.NetParameter.class_enable', index=13,
      number=204, type=5, cpp_type=1, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='class_name', full_name='caffe.NetParameter.class_name', index=14,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='nms_thresh', full_name='caffe.NetParameter.nms_thresh', index=15,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='conf_thresh', full_name='caffe.NetParameter.conf_thresh', index=16,
...
_SOLVERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='stepreset', full_name='caffe.SolverParameter.stepreset', index=24,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='stepvalue', full_name='caffe.SolverParameter.stepvalue', index=25,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='solver_type', full_name='caffe.SolverParameter.solver_type', index=34,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='log_path', full_name='caffe.SolverParameter.log_path', index=40,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='plateau_ontest', full_name='caffe.SolverParameter.plateau_ontest', index=41,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='plateau_lossidx', full_name='caffe.SolverParameter.plateau_lossidx', index=42,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='plateau_winsize', full_name='caffe.SolverParameter.plateau_winsize', index=43,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='plateau_extendstep', full_name='caffe.SolverParameter.plateau_extendstep', index=44,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='plateau_mean_ratio', full_name='caffe.SolverParameter.plateau_mean_ratio', index=45,
...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='precision_param', full_name='caffe.LayerParameter.precision_param', index=17,
      number=5091, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='proposal_param', full_name='caffe.LayerParameter.proposal_param', index=46,
...
_PRECISIONPARAMETER = _descriptor.Descriptor(
  name='PrecisionParameter',
  full_name='caffe.PrecisionParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='exponent', full_name='caffe.PrecisionParameter.exponent', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='num_bits', full_name='caffe.PrecisionParameter.num_bits', index=1,
      number=2, type=13, cpp_type=3, label=1,
...
_PROPOSALPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ratios', full_name='caffe.ProposalParameter.ratios', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='scales', full_name='caffe.ProposalParameter.scales', index=3,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='pre_nms_topn', full_name='caffe.ProposalParameter.pre_nms_topn', index=4,
      number=5, type=13, cpp_type=3, label=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='post_nms_topn', full_name='caffe.ProposalParameter.post_nms_topn', index=5,
      number=6, type=13, cpp_type=3, label=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='nms_thresh', full_name='caffe.ProposalParameter.nms_thresh', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='min_size', full_name='caffe.ProposalParameter.min_size', index=7,
      number=8, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=300,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='copys', full_name='caffe.ProposalParameter.copys', index=8,
      number=9, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LAYERPARAMETER.fields_by_name['precision_param'].message_type = _PRECISIONPARAMETER
...
DESCRIPTOR.message_types_by_name['PrecisionParameter'] = _PRECISIONPARAMETER
...
class PrecisionParameter(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _PRECISIONPARAMETER

  # @@protoc_insertion_point(class_scope:caffe.PrecisionParameter)
