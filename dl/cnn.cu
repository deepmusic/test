...
void setup_shared_cnn(Net* const net)
{
  ...
  add_max_pool_layer(net, "pool1", "conv1_1", "pool1", 3, 3, 2, 2, 0, 0);
  ...
  add_max_pool_layer(net, "conv4_1_incep_pool", "conv3_4", "conv4_1_incep_pool", 3, 3, 2, 2, 0, 0);
  ...
  add_max_pool_layer(net, "conv5_1_incep_pool", "conv4_4", "conv5_1_incep_pool", 3, 3, 2, 2, 0, 0);
  ...
  add_max_pool_layer(net, "downsample", "conv3_4", "downsample", 3, 3, 2, 2, 0, 0);
